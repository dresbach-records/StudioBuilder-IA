...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="relative overflow-hidden pt-32">
      ...
      {/* Hero Section */}
      <section className="max-w-7xl mx-auto px-8 py-24 text-center space-y-12">
        ...
        <h1 className="text-6xl md:text-8xl font-black tracking-tighter leading-[0.9] text-white animate-in slide-in-from-bottom-8 duration-700">
        ...
        <p className="text-xl text-slate-400 max-w-3xl mx-auto leading-relaxed animate-in fade-in duration-1000">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-8 animate-in zoom-in-95 duration-1000">
          <Button 
            ...
            size="lg" 
            className="px-12 py-5 bg-primary text-white shadow-2xl shadow-primary/30 text-lg group"
          >
            Criar Meu Projeto
          ...
          <Button 
            variant="outline" 
            size="lg" 
            className="px-12 py-5 border-white/10 text-white hover:bg-white/5"
        ...
        {/* Dashboard Preview */}
        <div className="mt-24 relative max-w-5xl mx-auto rounded-[40px] border border-white/10 bg-black/40 p-4 shadow-[0_0_100px_rgba(37,99,235,0.1)] group">
           <div className="absolute inset-0 bg-gradient-to-t from-background-dark via-transparent to-transparent z-10"></div>
           <div className="overflow-hidden rounded-[32px] border border-white/5">
              <img 
           ...
           <div className="absolute bottom-12 left-12 z-20 text-left space-y-4">
              <div className="flex gap-2">
                 <div className="w-3 h-3 rounded-full bg-rose-500"></div>
                 <div className="w-3 h-3 rounded-full bg-amber-500"></div>
                 <div className="w-3 h-3 rounded-full bg-emerald-500"></div>
              </div>
              <p className="text-sm font-mono text-emerald-500">$ studio-builder --deploy --autonomous</p>
              <p className="text-xs text-slate-500 uppercase font-black tracking-widest">Engine v4.2.0 Stable Connected</p>
           </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-8 py-32 grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          ...
          <div key={i} className="p-10 bg-white/5 border border-white/10 rounded-[32px] hover:border-primary/40 transition-all group space-y-6">
      ...
      {/* CTA Final */}
      <section className="bg-primary/5 border-y border-white/5 py-32 text-center">
        <div className="max-w-3xl mx-auto px-8 space-y-8">
           <h2 className="text-4xl font-black text-white">Pronto para digitalizar sua engenharia?</h2>
